    ...
    <section id="logSection">
        <article v-for="[id, logGroup] in Object.entries(logs)" :key="id">
            ...
            <accordion-element
                class="log"
                data-group="root"
                v-if="'request' in logGroup"
            >
                <div class="ploiu-accordion-title">
                    <span
                        :class="`request-method request-method-${logGroup.request.method.toLowerCase()}`"
                        >{{ logGroup.request.method }}</span
                    >
                    <span class="url">{{ logGroup.request.url }}</span>
                    <span v-if="'response' in logGroup" class="http-code"
                        >HTTP {{ logGroup.response.statusCode }}</span
                    >
                </div>
                <div class="ploiu-accordion-body">
                    <!-- request log -->
                    <accordion-element
                        class="log-success request-response-log"
                        v-if="'request' in logGroup"
                    ...
                    >
                        <div class="ploiu-accordion-title">
                            <span>Request</span>
                            <span class="date">{{
                                formatDate(logGroup.request.timestamp)
                            }}</span>
                        </div>
                        <div class="ploiu-accordion-body">
                            <!-- headers -->
                            <accordion-element
                                class="headers-body-log"
                                data-group="headers/body"
                            >
                                <div class="ploiu-accordion-title">Headers</div>
                                <div class="ploiu-accordion-body">
                            ...
                            <accordion-element
                                ...
                                v-if="
                                    ...
                                    logGroup.request.body.trim().length > 0
                                "
                            >
                                <div class="ploiu-accordion-title">
                                    Request Body
                    ...
                    <accordion-element
                        class="log-success request-response-log"
                        v-if="'response' in logGroup"
                        data-group="request/response"
                    >
                        <div class="ploiu-accordion-title">
                            <span>Response</span>
                            <span class="date">{{
                                formatDate(logGroup.response.timestamp)
                            }}</span>
                        </div>
                        <div class="ploiu-accordion-body">
                            ...
                            <accordion-element
                                ...
                                v-if="
                                    ...
                                    logGroup.response.body.trim().length > 0
                                "
                            >
                                <div class="ploiu-accordion-title">
                                    Response Body
            ...
            <section class="log-error" v-if="'error' in logGroup">
                ...
                <span class="date">{{
                    formatDate(logGroup.error.timestamp)
                }}</span>
            </section>
        </article>
        <Button severity="danger" id="clearLogs" rounded @click="clearLogs">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <g id="trash">
                    <path
                        d="M20,8.7H4A.75.75,0,1,1,4,7.2H20a.75.75,0,0,1,0,1.5Z"
                    />
                    <path
                    ...
                    />
                    <path
                        d="M10.22,17a.76.76,0,0,1-.75-.75V11.72a.75.75,0,0,1,1.5,0v4.52A.75.75,0,0,1,10.22,17Z"
                    />
                    <path
                        d="M13.78,17a.75.75,0,0,1-.75-.75V11.72a.75.75,0,0,1,1.5,0v4.52A.76.76,0,0,1,13.78,17Z"
                    />
                </g>
            </svg>
        </Button>
