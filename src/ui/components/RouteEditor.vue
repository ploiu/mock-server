...
<template>
    <section id="routeEditor">
            ...
            <div class="col-4" v-if="item.routeType === RouteTypes.DEFAULT">
                <FloatLabel id="responseStatusCodeWrapper">
                    <InputText
                        ...
                        @update:model-value="
                            (e) => {
                                props.route!.responseStatus = Number(e);
                                valueChange();
                            }
                        "
                    />
        ...
        <div
            id="httpHeadersRow"
            class="row"
            v-if="item.routeType === RouteTypes.DEFAULT"
        >
            <div class="col-12">
        ...
        <div
            id="redirectUrl"
            class="row"
            v-if="item.routeType == RouteTypes.PASSTHROUGH"
        >
            <div class="col-12">
        ...
        Reason we import the raw svg is so that we don't have to add extra code to the backend to service the fonts file -->
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <g id="save">
                    ...
                    />
                    <path
                        d="M16.75,20h-1.5V13.75H8.75V20H7.25V13.5A1.25,1.25,0,0,1,8.5,12.25h7a1.25,1.25,0,0,1,1.25,1.25Z"
                    />
                    <path
                        d="M12.47,8.75H8.53a1.29,1.29,0,0,1-1.28-1.3V4h1.5V7.25h3.5V4h1.5V7.45A1.29,1.29,0,0,1,12.47,8.75Z"
                    />
                </g>
            </svg>
        </Button>
