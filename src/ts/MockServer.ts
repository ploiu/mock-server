import {Response, serve, Server,} from "https://deno.land/std@0.100.0/http/mod.ts";
...
import {cyan, green, magenta, yellow,} from "https://deno.land/std@0.100.0/fmt/colors.ts";
